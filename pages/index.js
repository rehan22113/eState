...
<section className="text-gray-600 body-font bg-[#C7CEEA] overflow-hidden">
  <div className=' relative z-10 top-72'>
   ...
   <div className=' relative z-10 top-[34rem] left-96 overflow-hidden'>
    <img src='/zig-zag.svg' className='w-32'/>
   </div>
...
<section className="text-gray-600 body-font">
  <div className="container px-5 py-2 mx-auto md:w-[70%] w-[90%]">
    ...
    <button className="btn mx-auto flex items-center bg-[#FF9AA2] border-1 py-2 px-8 focus:outline-none hover:bg-gray-200 text-base text-white mt-4 md:mt-0">Register
    ...
    <div className="flex flex-wrap -m-4">
      <div className="p-4 lg:w-1/4 md:w-1/2">
        <div className="h-full flex flex-col items-center text-center">
          <img alt="team" className="flex-shrink-0 w-full h-64 object-center mb-4" src="/rectangle-6@2x.png" />
      ...
      <div className="p-4 lg:w-1/4 md:w-1/2">
        <div className="h-full flex flex-col items-center text-center">
          <img alt="team" className="flex-shrink-0 w-full h-64 object-center mb-4" src="/rectangle-11@2x.png" />
          <div className="w-full">
      ...
      <div className="p-4 lg:w-1/4 md:w-1/2">
        <div className="h-full flex flex-col items-center text-center">
          <img alt="team" className="flex-shrink-0 w-full h-64 object-center mb-4" src="/rectangle-29@2x.png" />
          <div className="w-full">
...
<footer className="text-gray-600 body-font bg-[#FFB7B2] mt-10">
